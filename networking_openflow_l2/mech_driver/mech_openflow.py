# Copyright (C) 2015 National Chiao Tung University, Taiwan.
# Copyright (C) 2015 Yi Ren Chen <nobody at hostname not exist>
...
from networking_openflow_l2.common import constants
...
class OpenFlowL2MechanismDriver(mech_agent.SimpleAgentMechanismDriverBase):
    ...
    def __init__(self):
        ...
        super(OpenFlowYirenMechanismDriver, self).__init__(
            constants.AGENT_TYPE_OPENFLOW,
